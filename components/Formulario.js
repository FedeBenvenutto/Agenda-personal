    ...
    <>
      <SafeAreaView style={styles.formulario}>
        ...
        <TextInput
          ...
          onChangeText={(value) => setPersona({ ...persona, Apellido: value })}
        ></TextInput>
      </SafeAreaView>
      <SafeAreaView style={styles.formulario}>
      ...
      <SafeAreaView style={styles.formulario}>
        ...
        <TextInput
          ...
          onChangeText={(value) => setPersona({ ...persona, Telefono: value })}
        ></TextInput>
      </SafeAreaView>
      <SafeAreaView style={styles.formulario}>
        ...
        <TextInput
          ...
          onChangeText={(value) => setPersona({ ...persona, Telefono2: value })}
        ></TextInput>
      </SafeAreaView>
      <SafeAreaView style={styles.formulario}>
        ...
        <TextInput
          ...
          onChangeText={(value) => setPersona({ ...persona, Prioridad: value })}
        ></TextInput>
      </SafeAreaView>
      <SafeAreaView style={styles.formulario}>
